...
filePATH = '/content/drive/MyDrive/genetic/deep-learning-project-cracking-the-genetic-code/DATA/'
fileOne = 'humanORFs.txt'
fileTwo = 'humanProteins.txt'

# Call the loadData function with the file paths
...
def updateANDsave_heatmap(this_epoch, this_batch_ID, sampling_D, this_table, this_time, Ncod, last_training_accuracy):
    ...
    figurePATH = "/content/drive/MyDrive/Output/RNN2layers256weights/pdf/"
    plt.savefig(figurePATH + figNamePDF)
    
    figurePATH = "/content/drive/MyDrive/Output/RNN2layers256weights/svg/"
    plt.savefig(figurePATH + figNameSVG)
#sys.exit()